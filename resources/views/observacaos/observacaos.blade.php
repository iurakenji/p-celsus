...
<br>
    <div class="text-center" style="margin: 0px 20px">
        <h4>Observações de Matérias-Primas</h4><hr>
    </div>
...
<div class="d-grid gap-1 d-md-flex justify-content-md-center">
    <a class="btn btn-primary icon-link shadow text-primary-emphasis bg-primary-subtle border border-primary-subtle rounded-3" href="{{ route('observacaos.create') }}" role="button">
