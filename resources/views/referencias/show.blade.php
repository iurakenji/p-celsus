    ...
    <form action=" {{ route('referencias.update', ['referencia' => $referencia->id]) }} " method="post">
        ...
        <input type="hidden" name="_method" value="PUT">
            <div class="m-3">
                ...
                <input class="form-control"  type="text" id="nome" name="nome" value="{{ $referencia->nome }}">
            </div>
            <div class="m-3">
            <label class="form-label" for='descricao' title='Descrição'>Descrição: </label>
            <input class="form-control" type="text" id="descricao" name="descricao" value="{{ $referencia->descricao }}">
            </div>
