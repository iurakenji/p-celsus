...
class AnaliseSeeder extends Seeder
{
    ...
    {
        DB::table('analises')->insert(['nome' => 'Características Organolépticas', 'tipo' => 'Categórica Nominal','unidade' => null, 'observacao' => null, 'margem' => 0, 'valor_ar' => 5, 'tipo_id' => 1]);
        DB::table('analises')->insert(['nome' => 'Solubilidade em água', 'tipo' => 'Categórica Ordinal','unidade' => null, 'observacao' => null, 'margem' => 0, 'valor_ar' => 1, 'tipo_id' => 1]);
        DB::table('analises')->insert(['nome' => 'Solubilidade em álcool', 'tipo' => 'Categórica Ordinal','unidade' => null, 'observacao' => null, 'margem' => 0, 'valor_ar' => 1, 'tipo_id' => 1]);
